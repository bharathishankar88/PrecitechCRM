...
class RMController extends Controller
{
    ...
    public function viewDataOut()
    {
        ...
        return view('rm.formout',compact('data','data1','data2','data3'));
    }
    // save
    public function viewDataOutSave(Request $request)
    {
       ...
       //DB::insert('insert into rmins (name,id) values (?,?)', [$name,$id]); 
       DB::insert('INSERT INTO rmouts (id,supplierid,gradeid,sizerm,quantity,created_at,modified_at,created_by,modified_by) VALUES', [$id,$supplierid,$gradeid,$size,$quantity]);
